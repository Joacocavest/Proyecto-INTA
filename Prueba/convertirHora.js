...
id_collar = cadenaDecodificada.slice(caracterLeido, cantidadCaracterDecodificado);
console.log(id_collar);
...
longitud = cadenaDecodificada.slice(caracterLeido, cantidadCaracterDecodificado);
...
console.log(paqueteDeDatos.fecha);
console.log(paqueteDeDatos.hora);
let fechaYHora = paqueteDeDatos.fecha.concat(" " + paqueteDeDatos.hora);
console.log(fechaYHora);

//let moment = require('moment-timezone'); //Para trabajar en entornos de Node.JS
//import moment from 'moment-timezone';
//let fechaYHoraConvertidas = moment().tz('America/Argentina/Buenos_Aires').format('DD-MM-YYYY HH:mm:ss');
//console.log(fechaYHoraConvertidas);
