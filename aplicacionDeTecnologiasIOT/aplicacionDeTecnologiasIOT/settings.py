"""
Django settings for aplicacionDeTecnologiasIOT project.
...
SECRET_KEY = 'django-insecure-n$hsjwunb4f1qg1*z7@yi!k%990%sl)#76#%9459^-yw&pb#jo'
...
ROOT_URLCONF = 'aplicacionDeTecnologiasIOT.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.usuario.context_processors.solicitudes_pendientes_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'aplicacionDeTecnologiasIOT.wsgi.application'
...
STATIC_URL = '/aplicacionDeTecnologiasIOT/static/'
