...
class Usuario(AbstractUser):
    CUIG = models.ForeignKey("usuario.Establecimiento", on_delete=models.CASCADE, related_name='usuario_establecimiento', null=True, blank=True)
    nombre = models.CharField(max_length=50, blank=False)
    apellido = models.CharField(max_length=50, blank=False)
    nombre_usuario = models.CharField(max_length=50, blank=False, unique=True)
    contraseña = models.CharField(max_length=128, blank=False, unique=True)
...
class Cuidador(models.Model):
    ...
    nombre_cuidador = models.CharField(max_length=50, blank=False)
    apellido_cuidador = models.CharField(max_length=50, blank=False)
    email = models.EmailField(unique=True, blank=False)
    telefono = models.CharField(max_length=15, blank=True)
...
class Rol(models.Model):
    nombre_rol = models.CharField(max_length=50, unique=True, null=False, blank=False)
